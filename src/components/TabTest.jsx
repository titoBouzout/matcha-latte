...
import { Tabs, TabLabel, TabContent, TabList, TabPanel } from "./Tabs/index.js";
      ...
      <div class={`${tabStyles.Tabs} ${tabStyles.vertical}`}>
        <Tabs>
          ...
          >
            <FoldButton />
            <TabList>
              <TabLabel class={tabStyles.italic} aria-label="Caelestia Vars">
                <ExpandedTextIcon icon={CogIcon} text="Caelestia Vars" />
              </TabLabel>
              <TabLabel aria-label="Caelestia Colors" onClick={doLog}>
                <ExpandedTextIcon icon={ChatIcon} text="Caelestia Colors" />
              </TabLabel>
            </TabList>
